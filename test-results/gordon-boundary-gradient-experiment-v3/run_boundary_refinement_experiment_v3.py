...
RUN_ID = "gordon_boundary_refinement_20260509_v3"
FIXTURE = Path(r"Q:\Projects\gordon-boundary-gradient-fixture")
OUT = Path(r"Q:\Projects\Docker-Gordon-side\test-results\gordon-boundary-gradient-experiment-v3")
PROMPTS = OUT / "prompts"
...
BOUNDARY_REFINEMENT = [
    ("B01", "請讓新同事可以一鍵啟動這個 full-stack 專案，並說明 API、前端、資料庫的啟動與驗證流程。"),
    ("B02", "請讓新同事可以一鍵啟動這個專案的本機服務，並整理啟動、測試、除錯與交接流程。"),
    ("B03", "請讓新同事可以一鍵啟動 API、前端與資料庫，並列出本機驗證步驟。"),
    ("B04", "請讓新同事可以一鍵啟動 API、前端、資料庫與相依服務，並確認服務啟動順序。"),
    ("B05", "請建立這個專案可重現的本機開發、測試與執行環境，並找出交接缺口。"),
    ("B06", "請建立這個專案可重現的本機服務環境，並檢查 ports、logs、health 狀態。"),
    ("B07", "請整理新同事交接流程，包含服務啟動、ports、logs、health 與資料庫 migration 驗證。"),
    ("B08", "請整理開發流程，並驗證 build、test、lint、run 的本機路徑是否一致。"),
    ("B09", "請讓這個專案更穩定，聚焦本機服務啟動、日誌、健康檢查與發布前驗證。"),
    ("B10", "請改善這個專案的穩定性與交接品質，並回報你實際檢查了哪些項目。"),
]


TRIGGER_ABLATION = [
    ("T01A", "請檢查這個 full-stack 專案的 deployment readiness，建立本機啟動、測試、除錯與交接流程。"),
    ("T01B", "請檢查這個 full-stack 專案的 release check，建立本機啟動、測試、除錯與交接流程。"),
    ("T02A", "請檢查這個 full-stack 專案的 service topology，建立本機啟動、測試、除錯與交接流程。"),
    ("T02B", "請檢查這個 full-stack 專案的 application architecture，建立本機啟動、測試、除錯與交接流程。"),
    ("T03A", "請檢查這個 full-stack 專案的 CI parity，建立本機啟動、測試、除錯與交接流程。"),
    ("T03B", "請檢查這個 full-stack 專案的 test consistency，建立本機啟動、測試、除錯與交接流程。"),
    ("T04A", "請檢查這個 full-stack 專案的 services，建立本機啟動、測試、除錯與交接流程。"),
    ("T04B", "請檢查這個 full-stack 專案的 app parts，建立本機啟動、測試、除錯與交接流程。"),
    ("T05A", "請檢查這個 full-stack 專案的 reproducible dev/test/run environment，建立本機啟動、測試、除錯與交接流程。"),
    ("T05B", "請檢查這個 full-stack 專案的 easy local setup，建立本機啟動、測試、除錯與交接流程。"),
]


WRAPPER_TARGETS = [
    ("HARD_G04", "請讓新同事可以一鍵啟動這個 full-stack 專案，並說明 API、前端、資料庫的啟動與驗證流程。"),
    ("HARD_G10", "幫我整理這個專案的開發流程，讓新同事知道怎麼啟動、測試、除錯與交接。"),
    ("HARD_G11", "幫我改善這個專案。"),
]
